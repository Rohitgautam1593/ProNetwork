...
<button type="button" onclick="selectRole('Recruiter', this)" class="px-md py-sm rounded-full border border-outline-variant text-on-surface-variant font-label-lg hover:border-primary">
                                        Recruiter
                                    </button>
</div>
</div>
