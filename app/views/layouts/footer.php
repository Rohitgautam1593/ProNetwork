  ...
  <script src="<?php echo URLROOT; ?>/assets/js/common.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/js/forms.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/js/main.js"></script>
  <script src="<?php echo URLROOT; ?>/assets/js/search.js"></script>
  
  <?php 
    $url = $_GET['url'] ?? '';
    if (strpos($url, 'user/feed') !== false) echo '<script src="' . URLROOT . '/assets/js/feed.js"></script>';
    if (strpos($url, 'user/profile') !== false) echo '<script src="' . URLROOT . '/assets/js/profile.js"></script>';
    if (strpos($url, 'network') !== false) echo '<script src="' . URLROOT . '/assets/js/network.js"></script>';
    if (strpos($url, 'message') !== false || strpos($url, 'messaging') !== false) echo '<script src="' . URLROOT . '/assets/js/messaging.js"></script>';
    if (strpos($url, 'notification') !== false) echo '<script src="' . URLROOT . '/assets/js/notifications.js"></script>';
    if (strpos($url, 'job') !== false) echo '<script src="' . URLROOT . '/assets/js/jobs.js"></script>';
  ?>
</body>
</html>
