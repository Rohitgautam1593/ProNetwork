...
<span data-user-summary class="text-gray-500 font-body-md">Alex Harrison â€¢ San Francisco, CA â€¢ Software Engineering</span>
</div>
<button id="open-settings-edit" class="text-[#0A66C2] font-semibold hover:underline px-3 py-1 rounded transition-colors group-hover:bg-blue-50">Edit</button>
</div>
<!-- Item 2 -->
<div class="p-6 flex justify-between items-start hover:bg-gray-50 transition-colors group">
<div class="flex flex-col gap-1">
