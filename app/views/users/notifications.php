        ...
        <aside class="md:col-span-3 flex flex-col gap-2">
            <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden font-manrope text-sm sticky top-20">
                ...
                <div class="divide-y divide-slate-100">
                    <button class="w-full flex items-center gap-3 px-4 py-3 bg-slate-100 text-[#0A66C2] font-bold transition-all duration-200 hover:bg-slate-50 text-left">
                        <span class="material-symbols-outlined text-xl">settings</span>
                        <span>Settings</span>
                    </button>
                    <button class="w-full flex items-center gap-3 px-4 py-3 text-slate-600 transition-all duration-200 hover:bg-slate-50 text-left">
        ...
        <section class="md:col-span-6 flex flex-col gap-4">
            ...
            <div class="bg-white p-4 rounded-lg border border-slate-200 shadow-sm flex justify-between items-center">
                <div class="flex gap-2">
                    <span class="bg-[#0A66C2] text-white px-3 py-1 rounded-full text-xs font-semibold">All</span>
                    <span class="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-semibold hover:bg-slate-200 cursor-pointer">My posts</span>
                    <span class="bg-slate-100 text-slate-600 px-3 py-1 rounded-full text-xs font-semibold hover:bg-slate-200 cursor-pointer">Mentions</span>
                </div>
            ...
            <button class="bg-white w-full py-3 rounded-lg border border-slate-200 shadow-sm font-semibold text-slate-600 hover:bg-slate-50 transition-colors">
