        ...
        <div id="policy-content" class="prose prose-slate max-w-none text-slate-600 text-sm leading-relaxed space-y-6">
          ...
          <section class="policy-block space-y-3">
            <h2 class="text-xl font-bold text-slate-800 flex items-center gap-2">
              ...
              1. What are Guest Controls?
            </h2>
            <p>
              Even if you do not have an account or have logged out of ProNetwork, you still have control over how we collect and process certain session information. This Guest Controls page details how you can configure your ad preferences and cookie collection.
            </p>
          </section>
          ...
          <section class="policy-block space-y-3">
            ...
            <p>
              ProNetwork partners with advertisers to display relevant job postings. If you do not want to receive interest-based, personalized ads as a guest, you can turn off behavioral tracking cookies by managing your browser options or using industry opt-out portals.
            </p>
          </section>
          ...
          <section class="policy-block space-y-3">
            <h2 class="text-xl font-bold text-slate-800 flex items-center gap-2">
              <span class="w-1.5 h-6 bg-[#0A66C2] rounded-full"></span>
              3. Unsubscribing from Email Alerts
            </h2>
            <p>
              If you receive promotional emails or job notifications from ProNetwork, you can click the "Unsubscribe" link at the bottom of any email to stop receiving those messages. This will unsubscribe your email address directly, without requiring you to log in.
            </p>
          </section>
          ...
          <section class="policy-block space-y-3">
            ...
            <p>
              Your public ProNetwork profile may be indexed by external search engines like Google or Bing. If you wish to restrict the visibility of your profile to logged-in ProNetwork users only, you can adjust your profile privacy settings inside your account dashboard.
            </p>
          </section>
