      ...
      <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden p-6 md:p-8">
        ...
        <div id="policy-content" class="prose prose-slate max-w-none text-slate-600 text-sm leading-relaxed space-y-6">
          ...
          <section class="policy-block space-y-3">
            ...
            <p>
              ProNetwork values your privacy. This Privacy Policy describes how we collect, use, process, and share your personal information in connection with your access to and use of our platform, including our website and mobile applications.
            </p>
          </section>
          ...
          <section class="policy-block space-y-3">
            ...
            <ul class="list-disc pl-5 space-y-2">
              <li><strong>Account Registration:</strong> Your name, email address, password, and professional background.</li>
              <li><strong>Profile Information:</strong> Experience, education, skills, photo, location, and connections.</li>
              <li><strong>Posts and Content:</strong> Messages, posts, comments, article shares, and media files you upload.</li>
            </ul>
          </section>
          ...
          <section class="policy-block space-y-3">
            ...
            <p>
              We use your data to authorize login, personalize your feed, suggest connections, suggest job listings, send system notifications, and provide messaging and networking features.
            </p>
          </section>
          ...
          <section class="policy-block space-y-3">
            ...
            <p>
              Your profile is visible to other registered Members of ProNetwork. By default, your network connection lists, profile photo, headline, and public posts are viewable by all logged-in users. We do **not** sell your personal data to third parties.
            </p>
          </section>
          ...
          <section class="policy-block space-y-3">
            ...
            <p>
              You have the right to edit or delete your profile information, manage your email settings in the Account Settings menu, request access to a copy of your personal data, or delete your account entirely.
            </p>
          </section>
